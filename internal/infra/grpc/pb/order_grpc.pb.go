...
func (c *listOrdersServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderList, error) {
	out := new(OrderList)
...
func (UnimplementedListOrdersServiceServer) ListOrders(context.Context, *Blank) (*OrderList, error) {
